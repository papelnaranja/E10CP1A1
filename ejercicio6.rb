...
pepe = Student.new('pepe', 7, 3)
lucas = Student.new('lucas', 5, 5)
jose = Student.new('jose', 4, 5)
sofia = Student.new('sofia', 7, 3)
leo = Student.new('leo', 4, 3)
ivo = Student.new('ivo', 5, 3)
seba = Student.new('seba', 6, 3)
camila = Student.new('camila', 2, 1)
juan = Student.new('juan', 4, 3)
bianca = Student.new('bianca', 5, 2)
